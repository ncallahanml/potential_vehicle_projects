...
The latest YOLO models are used for both object detection and instance segmentation. Many options exist to balance performance and accuracy, detection should be quite accurate out of the box during the daytime. 
...
Available metrics to draw from the run, will be updated in real time or summarized at the end of the run dependent on settings.
...
- `silent` - run the algorithm and nothing else. ***Overrides other settings***
- `
- `annotate` - Labels & saves images
- `save` - Stores tabular results
- `debug` - default, prints debugging statements
...
#### Defaults:
| *Dataset*     | *Classes*    | *Defaults*             |
|:-------------:|:------------:|:----------------------:|
| [`COCO`]()        | [Classes]()  | Cars, Trucks           |
| [`Aerial`](https://universe.roboflow.com/fastnuces/parking-hnrcc)      | [Classes]()  | Vehicles, Empty Spaces |
| [`Parking Lot`] | [Classes]()  | Vehicles, Empty Spaces |
